// TEMPORARY (2026-05-18): short-lived access-token endpoint for the
// SDK feasibility test at /sdk-test.html on the dashboard. Returns the
// access_token derived from the refresh token in env. Guarded by a
// shared secret in the ?key= query param.
//
// DELETE THIS FILE after the test completes — it exposes Spotify access
// tokens to anyone who guesses the URL + key.
